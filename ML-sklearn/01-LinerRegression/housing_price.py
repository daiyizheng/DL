...
#读取数据
housing = pd.read_csv('../data/美国King County房价预测训练赛/kc_train.csv', header=None)
target=pd.read_csv('../data/美国King County房价预测训练赛/kc_train2.csv', header=None)  #销售价格
t=pd.read_csv('../data/美国King County房价预测训练赛/kc_test.csv', header=None)         #测试数据
...
df_result.to_csv("../result/housing_price_result.csv")