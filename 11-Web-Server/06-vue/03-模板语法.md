...
## 同名简写​
仅支持 3.4 版本及以上
如果 attribute 的名称与绑定的 JavaScript 变量的名称相同，那么可以进一步简化语法，省略 attribute 值：同名简、
仅支持 3.4 版本及以上
如果 attribute 的名称与绑定的 JavaScript 变量的名称相同，那么可以进一步简化语法，省略 attribute 值：````html
<!-- 与 :id="id" 相同 -->
<div :id></div>
...
<img src="https://cn.vuejs.org/assets/directive.DtZKvoAo.png">
