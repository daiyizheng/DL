...
res = mg.query("ZNF263", scopes="symbol", fields="uniprot", species="human")
print(res)

res = mg.query("ZNF263", scopes="symbol", fields="uniprot,ensembl,entrezgene,refseq", species="human")
print(res)


## Convert diffenent IDs to each other
res = mg.query("O14978", scopes="uniprot", fields="entrezgene,ensembl", species="human")
print(res)
...
gene_info = mg.querymany(gene_list, scopes="symbol", fields="uniprot,ensembl,entrezgene,refseq", species="human")
print(gene_info)
